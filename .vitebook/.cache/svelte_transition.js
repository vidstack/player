import { cubicInOut, cubicOut } from './chunk-V4MKZDOB.js';
import { assign, identity, is_function } from './chunk-KO5NNRVU.js';
...
function blur(
  ...
  return {
    ...
    easing,
    css: (_t, u) =>
      `opacity: ${target_opacity - od * u}; filter: ${f} blur(${u * amount}px);`
  };
}
