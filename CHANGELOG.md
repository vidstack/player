...
- **vidstack:** apply interactive state to slider via keyboard ([39f7c54](https://github.com/mihar-22/vidstack/commit/39f7c543f2f23bedefb717812329745a96adb8b3))
- **vidstack:** configure hls low latency mode based on stream type ([a96a3a8](https://github.com/mihar-22/vidstack/commit/a96a3a81b5741361dae85b418bc84bceaf177fba))
- **vidstack:** default to 60 seconds for min dvr window based on guidelines ([50f3a9b](https://github.com/mihar-22/vidstack/commit/50f3a9b81891f9ae658147eb8bd2222c96d584d1))
- **vidstack:** focus outline offset should match thumb size on slider ([1ebe8a0](https://github.com/mihar-22/vidstack/commit/1ebe8a0a6b8cc029a053b602da79f46a7e00fc35))
- **vidstack:** improved slider keyboard support ([6239bc6](https://github.com/mihar-22/vidstack/commit/6239bc6ffad8199f70a7f14d0c02526771711ed0)), closes [#776](https://github.com/mihar-22/vidstack/issues/776)
- **vidstack:** remove `img-` attr prefix for `<media-poster>` ([ba27b77](https://github.com/mihar-22/vidstack/commit/ba27b77a9c2f240aa4b30dce81d92c363a7832eb))
- **vidstack:** remove default border radius on buttons ([d153f89](https://github.com/mihar-22/vidstack/commit/d153f890c72c9b58b2ee53c008d5428309dde1bd))
- **vidstack:** rename `<media-slider-value-text>` -> `<media-slider-value>` ([bf26141](https://github.com/mihar-22/vidstack/commit/bf26141851ad82fc7a10a31f298ce4a1331d2cb8))
- **vidstack:** rename `bufferedAmount` to `bufferedEnd` ([9b01edf](https://github.com/mihar-22/vidstack/commit/9b01edfbc9e89d50836ff3b3139e8d0e1c4d682f))
- **vidstack:** rename `error` attr to `hidden` on `<media-slider-video>` ([3150484](https://github.com/mihar-22/vidstack/commit/315048455d1e56c351b466ac2f534de98d12f087))
- **vidstack:** rename `keyboardStep` to `keyStep` on slider components ([2a6ea7a](https://github.com/mihar-22/vidstack/commit/2a6ea7a1ef351bdb4d5d8d719f1a2c36243ca7b0))
- **vidstack:** rename `seekableAmount` to `seekableEnd` ([6e32e06](https://github.com/mihar-22/vidstack/commit/6e32e068149daad2a0c0d4f1dc94b667e3a60def))
- **vidstack:** rename var `--media-buffered-amount` to `--media-buffered-end` ([77fee5a](https://github.com/mihar-22/vidstack/commit/77fee5acb8e1c12e9ef4013847bf0449b2965ff2))
- **vidstack:** rename var `--media-seekable-amount` to `--media-seekable-end` ([5a41129](https://github.com/mihar-22/vidstack/commit/5a411293919ec4e3b840a7d2020586e5a6d01d31))
- **vidstack:** retrieve buffered amount when can play is fired ([fd19012](https://github.com/mihar-22/vidstack/commit/fd190126df9d8545626de5c9dba08a79c81096a6))
- **vidstack:** revise live stream support api ([db656db](https://github.com/mihar-22/vidstack/commit/db656db71a63c846418a0bb27c84ebf04052d699))
- **vidstack:** smoother keyboard seeking on time slider ([07d06de](https://github.com/mihar-22/vidstack/commit/07d06deeadcdaab347e9d26cee83b27bdb3177e8))

### Features

- **vidstack:** add `live` and `live-edge` tailwind media variants ([2d9e6ae](https://github.com/mihar-22/vidstack/commit/2d9e6ae8aad994119713e15aff48f4e9ca050c02))
- **vidstack:** add keyboard support ([2b96b38](https://github.com/mihar-22/vidstack/commit/2b96b38689e4370fa2cdeedd4c34d59265709d11)), closes [#84](https://github.com/mihar-22/vidstack/issues/84)
- **vidstack:** expose `live-edge` attribute on `<media-player>` ([d8d891f](https://github.com/mihar-22/vidstack/commit/d8d891f64e0fd8db16e68fb59a7cb34a8e14ee71))
- **vidstack:** expose `live` attr on `<media-player>` ([9970c03](https://github.com/mihar-22/vidstack/commit/9970c03277e4004a09270546e485f9b930bd7234))
- **vidstack:** live stream support ([a840a4a](https://github.com/mihar-22/vidstack/commit/a840a4a155307cfe9c8d20b26d41c44a0871a90c)), closes [#775](https://github.com/mihar-22/vidstack/issues/775) [#265](https://github.com/mihar-22/vidstack/issues/265)
- **vidstack:** new `--media-buffered-start` var ([2fca996](https://github.com/mihar-22/vidstack/commit/2fca9967cd0833451cab389d1bc7096213509199))
- **vidstack:** new `--media-seekable-start` var ([d57c7ba](https://github.com/mihar-22/vidstack/commit/d57c7baf85d123fd7a2aee1ca8e5e65fa044a363))
- **vidstack:** new `<media-live-indicator>` component ([68abac1](https://github.com/mihar-22/vidstack/commit/68abac102ba7820c7952ff55eb2231d13361f744)), closes [#734](https://github.com/mihar-22/vidstack/issues/734)
- **vidstack:** new `<media-seek-button>` component ([894c630](https://github.com/mihar-22/vidstack/commit/894c6306fed9a4b79fef599f526596ce7c497058)), closes [#758](https://github.com/mihar-22/vidstack/issues/758)
- **vidstack:** new `<media-slider-thumbnail>` component ([a3629e3](https://github.com/mihar-22/vidstack/commit/a3629e3c4d0a482eb05da251e5950d9d2c34d771)), closes [#763](https://github.com/mihar-22/vidstack/issues/763)
- **vidstack:** new `bufferedStart` media state prop ([371d9c0](https://github.com/mihar-22/vidstack/commit/371d9c010bcbd964faae68440dc83c792d5d9ab8))
- **vidstack:** new `currentLiveTime` media state prop ([d49b995](https://github.com/mihar-22/vidstack/commit/d49b995ecbbcd7c05cc111f8fdd05bd4eb1a80ae))
- **vidstack:** new `liveEdge` media state prop ([173be30](https://github.com/mihar-22/vidstack/commit/173be3085370d488b6b9af71b4106f093b3b4461))
- **vidstack:** new `liveTolerance` player prop ([107b1b1](https://github.com/mihar-22/vidstack/commit/107b1b1fcf441db280384080289bb04641cba3ff))
- **vidstack:** new `liveWindow` media state prop ([d55fd50](https://github.com/mihar-22/vidstack/commit/d55fd501a80eeb96d57e920c579731efa0850b28))
- **vidstack:** new `media-live-edge-request` event ([91232e0](https://github.com/mihar-22/vidstack/commit/91232e00fc1787c8bb0afea1741020d0e30262ed))
- **vidstack:** new `minLiveDVRWindow` media state ([fde19c4](https://github.com/mihar-22/vidstack/commit/fde19c4a63a5a89b1fb2d2e69f8251080cdf2088))
- **vidstack:** new `seekableStart` media state prop ([e1dc9fa](https://github.com/mihar-22/vidstack/commit/e1dc9fa5ed90f31645922a57e8a2a8251983e3dc))
- **vidstack:** new `seekToLiveEdge` player method ([d63ff65](https://github.com/mihar-22/vidstack/commit/d63ff656d04143dba283be7b745d54e923991b68))
- **vidstack:** new `streamType` player prop ([a182aa3](https://github.com/mihar-22/vidstack/commit/a182aa3b17505bfd998f0cc38fa86e20b45a2b8b))
- **vidstack:** new `styles/defaults.css` file ([60e1aac](https://github.com/mihar-22/vidstack/commit/60e1aacf97ed0c7d854a7052d99e49eb0263ccc7))
- **vidstack:** new `userBehindLiveEdge` media state prop ([1efe954](https://github.com/mihar-22/vidstack/commit/1efe9548c0af9efb40c3d6b7f39737aa6885ed6c))
- **vidstack:** new seek backward/forward icons ([6ab58d2](https://github.com/mihar-22/vidstack/commit/6ab58d2104d042cc74e484af259767fcbf47c924))
- **vidstack:** readonly atttrs on components are now data-attrs ([631ee19](https://github.com/mihar-22/vidstack/commit/631ee1912524adc067fb4acc058c1e4496633e93))
- **vidstack:** refactor media attributes to data attributes ([be705e2](https://github.com/mihar-22/vidstack/commit/be705e2572ec163b52ec0829b27273fa3f3acbf2))
- **vidstack:** tooltips support ([b187829](https://github.com/mihar-22/vidstack/commit/b187829eedc2b39b9d50f36673443e3e5f0386dd)), closes [#754](https://github.com/mihar-22/vidstack/issues/754)

## [0.3.3](https://github.com/mihar-22/vidstack/compare/v0.3.2...v0.3.3) (2023-02-26)

### Bug Fixes

- **vidstack:** slider video shrinking at edge ([9de215a](https://github.com/mihar-22/vidstack/commit/9de215a2ea8fd3811ac5d3d34d9992d5906cff3d))
- **vidstack:** user idle not removed on playback end ([1af57e4](https://github.com/mihar-22/vidstack/commit/1af57e4e88ed90d51380f5fa30cc50db4d4d0289)), closes [#783](https://github.com/mihar-22/vidstack/issues/783)
