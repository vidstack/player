  ...
  return (
    <MediaPlayer>
      ...
      <div className="relative h-6 w-full bg-gray-200">
        <div className="waiting:bg-sky-500 absolute top-0 left-0 h-full w-full origin-left scale-x-[calc(var(--media-current-time)/var(--media-duration))] transform bg-gray-400 will-change-transform"></div>
      </div>
    </MediaPlayer>
  );
}
