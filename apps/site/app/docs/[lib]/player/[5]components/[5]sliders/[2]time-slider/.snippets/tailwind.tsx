<MediaTimeSlider
  ...
  trackFillClass="live:bg-red-500 absolute top-1/2 left-0 z-20 h-1 w-[var(--slider-fill)] -translate-y-1/2 bg-white will-change-[width]"
  trackProgressClass="absolute top-1/2 left-0 z-10 h-1 w-[var(--slider-progress)] -translate-y-1/2 bg-[#878787] will-change-[width]"
  thumbContainerClass="absolute top-0 left-[var(--slider-fill)] z-20 h-full w-5 -translate-x-1/2 group-data-[dragging]:left-[var(--slider-pointer)]"
