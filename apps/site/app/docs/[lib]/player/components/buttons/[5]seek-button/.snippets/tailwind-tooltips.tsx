import { MediaSeekButton, MediaTooltip, SeekForwardIcon } from '@vidstack/react';

<MediaSeekButton className="group flex h-12 w-12 items-center justify-center rounded-sm text-white outline-none data-[focus]:ring-4 data-[focus]:ring-blue-400">
  {/* icon */}
  <SeekForwardIcon />
  {/* tooltip */}
  <MediaTooltip
