  ...
  return (
    <MediaMenu className="text-sm text-white">
      ...
      <MediaAudioMenuItems
        ...
        radioClass="group flex cursor-pointer items-center p-2.5 data-[hocus]:bg-gray-700/40 data-[focus]:ring-2 data-[focus]:ring-blue-400"
...
function AudioMenuButton() {
  return (
    <MediaMenuButton className="group flex cursor-pointer items-center p-2.5 data-[hocus]:bg-gray-700/40 data-[focus]:ring-2 data-[focus]:ring-blue-400">
      ...
      <MusicIcon className="h-6 w-6 group-aria-expanded:hidden" />
      <span className="ml-1.5">Audio</span>
      <span className="ml-auto text-gray-500" slot="hint"></span>
      <ChevronRightIcon className="ml-0.5 h-4 w-4 text-gray-500 group-aria-expanded:hidden group-aria-disabled:opacity-0" />
    </MediaMenuButton>
  );
}
