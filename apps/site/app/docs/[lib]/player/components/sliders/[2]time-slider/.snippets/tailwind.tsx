...
function SliderTrackFill() {
  return (
    <div
      className="live-edge:bg-red-500 absolute top-1/2 left-0 z-20 h-[var(--track-height)] w-full -translate-y-1/2 scale-x-[var(--slider-fill-rate)] transform bg-white will-change-transform"
