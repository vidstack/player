<MediaVolumeSlider
  ...
  trackFillClass="absolute bottom-0 left-1/2 z-20 w-1 h-[var(--slider-fill)] -translate-x-1/2 bg-white will-change-[height]"
  thumbContainerClass="absolute bottom-[var(--slider-fill)] left-1/2 z-20 w-full h-5 -translate-x-1/2 group-data-[dragging]:bottom-[var(--slider-pointer)]"
