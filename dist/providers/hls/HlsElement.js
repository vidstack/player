...
export class HlsElement extends VideoElement {
  ...
  buildHlsEngine() {
    ...
    this._hlsEngine = new Hls(
      (_a = this.hlsConfig) !== null && _a !== void 0 ? _a : {}
    );
...
export const HLS_ELEMENT_STORYBOOK_ARG_TYPES = Object.assign(
  Object.assign({}, VIDEO_ELEMENT_STORYBOOK_ARG_TYPES),
  {
