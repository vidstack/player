 ...
 * instance.
 */
export const mediaContainerContext: MediaContainerContext = createContext(() => createRef());
export type MediaContainerContext = Context<Ref<HTMLDivElement>>;
 ...
 * ```
 */
export type MediaPlayerConnectEvent<Provider extends MediaProviderElement = MediaProviderElement> =
...
export function WithMediaPlayer<T extends Constructor<LitElement>>(
  ...
  class MediaPlayer extends Provider {
    ...
    protected _mediaContainerRefProvider = mediaContainerContext.provide(this);
