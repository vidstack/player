...
export interface MediaLiveButtonAttributes extends Partial<LiveIndicatorProps>, Omit<JSX.HTMLAttributes<MediaLiveButtonElement>, keyof LiveIndicatorProps | "is"> {
}
