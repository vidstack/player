...
/**
   * Triggered when the video element's buffer state changes, either stalled or loaded. Check yload for state.
 * @detail data
 */
...
/**
   * Triggered when a font signalled by a DVB Font Download has been added to the document ntFaceSet interface.
 * @detail data
 */
export interface DASHDvbFontDownloadAddedEvent extends DASHMediaEvent<DASH.dvbFontDownloadAdded> { }

/**
   * Triggered when a font signalled by a DVB Font Download has successfully downloaded and the ntFace can be used.
 * @detail data
 */
export interface DASHDvbFontDownloadCompleteEvent extends DASHMediaEvent<DASH.dvbFontDownloadComplete> { }

/**
   * Triggered when a font signalled by a DVB Font Download could not be successfully wnloaded, so the FontFace will not be used.
 * @detail data
 */
...
/**
   * Triggered when a fragment download is abandoned due to detection of slow download base on e ABR abandon rule..
 * @detail data
 */
...
/**
   * Triggered when an ABR up /down switch is initiated; either by user in manual mode or auto de via ABR rules.
 * @detail data
 */
...
/**
   * The event is fired when the frame at the current playback position of the media has nished loading;
...
/**
   * Event that is dispatched whenever the player encounters a potential conformance validation at might lead to unexpected/not optimal behavior
 * @detail data
 */
...
/**
   * Event that is dispatched whenever an adaptation set is removed due to all representations t being supported.
 * @detail data
 */
