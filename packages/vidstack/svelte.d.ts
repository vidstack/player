...
export interface MediaLiveButtonAttributes extends Partial<LiveIndicatorProps>, Omit<import('svelte/elements').HTMLAttributes<MediaLiveButtonElement>, keyof LiveIndicatorProps | "is"> {
}
...
export interface MediaGestureAttributes extends Partial<GestureProps>, Omit<import('svelte/elements').HTMLAttributes<MediaGestureElement>, keyof GestureProps | "is"> {
}
