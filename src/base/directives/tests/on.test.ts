...
class MyElement extends LitElement {
  customEvent: keyof GlobalEventHandlersEventMap = 'vds-noop';

  customOptions?: boolean | AddEventListenerOptions | EventListenerOptions;

  clickOptions?: boolean | AddEventListenerOptions | EventListenerOptions;
...
describe('directives/on', function () {
  async function buildFixture() {
    return await fixture<MyElement>('<my-element></my-element>');
  }
