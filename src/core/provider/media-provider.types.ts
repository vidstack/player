...
export type MediaProviderElementRequestKey = string;

export type MediaProviderElementRequestAction = () => void | Promise<void>;

export type MediaProviderElementRequestQueue = Map<
