 ...
 * @event
 */
export type HlsSubtitleTracksUpdatedEvent =
  VdsHlsEvent<SubtitleTracksUpdatedData>;
 ...
 * @event
 */
export type HlsSubtitleFragProcessedEvent =
  VdsHlsEvent<SubtitleFragProcessedData>;
 ...
 * @event
 */
export type HlsNonNativeTextTracksFoundEvent =
  VdsHlsEvent<NonNativeTextTracksData>;
 ...
 * @event
 */
export type HlsFragLoadEmergencyAbortedEvent =
  VdsHlsEvent<FragLoadEmergencyAbortedData>;
 ...
 * @event
 */
export type HlsFragParsingInitSegmentEvent =
  VdsHlsEvent<FragParsingInitSegmentData>;
