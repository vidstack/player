...
import { ScriptLoader } from '../../utils/network';
import { kebabToCamelCase } from '../../utils/string';
import { isFunction, isString, isUndefined } from '../../utils/unit';
...
export async function importHlsConstructor(
  ...
  try {
    const hlsCtor = (await (importer as DynamicHlsConstructorImport)())
      ?.default;
