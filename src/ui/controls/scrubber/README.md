...
| `isSeeking` _(readonly)_             | Whether the user is seeking by either hovering over the scrubber or by dragging the thumb.                                                                                                                                                             | `boolean`                    | `undefined`                         |
...
| `previewTrackElement` _(readonly)_   | Returns the underlying preview track fill element (`<div>`). This will be `undefined` if you set the `noPreviewTrack` property to true.                                                                                                                | `HTMLDivElement ∣ undefined` | `undefined`                         |
| `progressElement` _(readonly)_       | Returns the underlying `<progress>` element.                                                                                                                                                                                                           | `HTMLProgressElement`        | `undefined`                         |
