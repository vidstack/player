...
| `fillPercent` _(readonly)_                      | The fill rate expressed as a percentage (`fillRate * 100`).                                                                                                  | `number`                    | `undefined`    |
| `fillRate` _(readonly)_                         | The current value to range ratio.                                                                                                                            | `number`                    | `undefined`    |
| `hasThumbReachedHumanPerceivedEnd` _(readonly)_ | Whether the thumb has been dragged to what a human would perceive as the end.                                                                                | `boolean`                   | `undefined`    |
| `hidden`                                        |                                                                                                                                                              | `boolean`                   | `false`        |
| `isDragging` _(readonly)_                       | Whether the slider thumb is currently being dragged.                                                                                                         | `boolean`                   | `undefined`    |
| `isOrientationHorizontal` _(readonly)_          | Whether the current orientation is horizontal.                                                                                                               | `boolean`                   | `undefined`    |
| `isOrientationVertical` _(readonly)_            | Whether the current orientation is vertical.                                                                                                                 | `boolean`                   | `undefined`    |
...
| `thumbContainerElement` _(readonly)_            | The thumb container element.                                                                                                                                 | `HTMLDivElement`            | `undefined`    |
| `thumbElement` _(readonly)_                     | The thumb element.                                                                                                                                           | `HTMLDivElement`            | `undefined`    |
| `trackElement` _(readonly)_                     | The track element.                                                                                                                                           | `HTMLDivElement`            | `undefined`    |
| `trackFillElement` _(readonly)_                 | The track fill element.                                                                                                                                      | `HTMLDivElement`            | `undefined`    |
