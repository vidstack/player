 ...
 * @returns {import("@types").Constructor<T>}
 */
 ...
 *
 * @param {unknown} value - The value to check.
 * @param {import("@types").Constructor<unknown>} constructor - The constructor to check against.
 * @returns {boolean}
 */
 ...
 * @param {import("@types").Constructor<unknown>} object - The object to search for in the prototype chain.
 * @returns {boolean}
 */
